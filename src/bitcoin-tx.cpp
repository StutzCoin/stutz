...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s stutz-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  stutz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stutz transaction") + "\n" +
              "  stutz-tx [options] -create [commands]   " + _("Create hex-encoded stutz transaction") + "\n" +
              "\n";
