...
const char * const BITCOIN_CONF_FILENAME = "stutz.conf";
const char * const BITCOIN_PID_FILENAME = "stutz.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Stutz";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Stutz";
#else
    // Unix
    return pathRet / ".stutz";
#endif
#endif
}
