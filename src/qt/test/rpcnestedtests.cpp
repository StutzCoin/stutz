...
void RPCNestedTests::rpcNestedTests()
{
    ...
    ClearDatadirCache();
    std::string path = QDir::tempPath().toStdString() + "/" + strprintf("test_stutz_qt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    ...
    //@TODO QVERIFY(result == "97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9");
